...
def setup_config() -> None:
    ...
    cs.store(group="tokenizer/normalizer", name="bert_normalizer_schema", node=BertNormalizerConfig)
    cs.store(group="tokenizer/normalizer", name="lower_case_normalizer_schema", node=LowercaseNormalizerConfig)
    cs.store(group="tokenizer/normalizer", name="nfc_normalizer_schema", node=NFCNormalizerConfig)
    cs.store(group="tokenizer/normalizer", name="nfd_normalizer_schema", node=NFDNormalizerConfig)
    cs.store(group="tokenizer/normalizer", name="nfkc_normalizer_schema", node=NFKCNormalizerConfig)
    cs.store(group="tokenizer/normalizer", name="nfkd_normalizer_schema", node=NFKDNormalizerConfig)
    cs.store(group="tokenizer/normalizer", name="nmt_normalizer_schema", node=NmtNormalizerConfig)
    cs.store(group="tokenizer/normalizer", name="replace_normalizer_schema", node=ReplaceNormalizerConfig)
    cs.store(group="tokenizer/normalizer", name="sequence_normalizer_schema", node=SequenceNormalizerConfig)
    cs.store(group="tokenizer/normalizer", name="strip_normalizer_schema", node=StripNormalizerConfig)
    cs.store(group="tokenizer/normalizer", name="strip_accents_normalizer_schema", node=StripAccentsNormalizerConfig)
